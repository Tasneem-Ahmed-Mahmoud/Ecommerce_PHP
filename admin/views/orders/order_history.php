        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg   pt-2   d-flex justify-content-between">
                <h6 class="text-white text-capitalize ps-3">Order History</h6>
                <a href="index.php" class="btn btn-warning  px-5 me-2"> <i class="fa fa-reply"></i> Back</a>
            ...
            <div class="card-body px-0 pb-2"  id="orders_table">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0   table-striped">
                  ...
                  <tbody>
                    <?php  if(!empty (getOrdersHistory())): 
                        $index=0;
                        foreach( getOrdersHistory() as $order):
                        $index++;
                        ?>
                    <tr>
